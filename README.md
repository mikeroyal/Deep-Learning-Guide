...
#### A guide covering Deep Learning including the applications, libraries, frameworks, and tools that will make you a better and more efficient with Deep Learning development.
...
1. [Deep Learning Learning Resources](https://github.com/mikeroyal/Deep-Learning-Guide#Deep-Learning-learning-resources)

2. [Deep Learning Tools, Libraries, and Frameworks](https://github.com/mikeroyal/Deep-Learning-Guide#Deep-Learning-tools-libraries-and-frameworks)

3. [Computer Vision Development](https://github.com/mikeroyal/Deep-Learning-Guide#computer-vision-development)

4. [Natural Language Processing (NLP) Development](https://github.com/mikeroyal/Deep-Learning-Guide#nlp-development)

5. [Bioinformatics](https://github.com/mikeroyal/Deep-Learning-Guide#bioinformatics)

6. [Algorithms](https://github.com/mikeroyal/Deep-Learning-Guide#algorithms)

7. [Machine Learning](https://github.com/mikeroyal/Deep-Learning-Guide#machine-learning)

8. [CUDA Development](https://github.com/mikeroyal/Deep-Learning-Guide#cuda-development)

9. [MATLAB Development](https://github.com/mikeroyal/Deep-Learning-Guide#matlab-development)

10. [Photogrammetry Development](https://github.com/mikeroyal/Deep-Learning-Guide#photogrammetry-development)

11. [Autodesk Development](https://github.com/mikeroyal/Deep-Learning-Guide#autodesk-development)

12. [LiDAR Development](https://github.com/mikeroyal/Deep-Learning-Guide#lidar-development)

13. [Robotics Development](https://github.com/mikeroyal/Deep-Learning-Guide#robotics-development)

14. [Linear Algebra](https://github.com/mikeroyal/Deep-Learning-Guide#linear-algebra)

15. [C/C++ Development](https://github.com/mikeroyal/Deep-Learning-Guide#cc-development)

16. [Python Development](https://github.com/mikeroyal/Deep-Learning-Guide#python-development)

17. [R Development](https://github.com/mikeroyal/Deep-Learning-Guide#r-development)

18. [Julia Development](https://github.com/mikeroyal/Deep-Learning-Guide#julia-development)

# Deep Learning Learning Resources
[Back to the Top](https://github.com/mikeroyal/Deep-Learning-Guide#table-of-contents)

[Deep Learning](https://www.ibm.com/cloud/learn/deep-learning) is a subset of machine learning, which is a neural network with three or more layers. These neural networks attempt to simulate the behavior of the human brain,though, far from matching its ability. This allows the neural networks to "learn" from large amounts of data. The Learning can be [supervised](https://en.wikipedia.org/wiki/Supervised_learning), [semi-supervised](https://en.wikipedia.org/wiki/Semi-supervised_learning) or [unsupervised](https://en.wikipedia.org/wiki/Unsupervised_learning).
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Deep-Learning-Guide/pulls).
